...
class SAC:
    ...
    def load(self,env):
        ...
        self.PolicyNetwork.load_state_dict(torch.load("config/saves/training_weights/"+env+"/sac_weights/actorWeights.pth"))
        self.VNetwork.load_state_dict(torch.load("config/saves/training_weights/"+env+"/sac_weights/VWeights.pth"))
        self.TargetVNetwork.load_state_dict(torch.load("config/saves/training_weights/"+env+"/sac_weights/TargetVWeights.pth"))
        self.Qnetwork.load_state_dict(torch.load("config/saves/training_weights/"+env+"/sac_weights/criticWeights.pth"))