import numpy as np
import torch
from rl_aerial_manipulation.pytorch_utils import hard_update,soft_update
import os
...
class SoftQ:
    ...
    def load(self,env):
        ...
        self.PolicyNetwork.load_state_dict(torch.load("config/saves/training_weights/"+env+"/softq_weights/actorWeights.pth"))
        self.Qnetwork.load_state_dict(torch.load("config/saves/training_weights/"+env+"/softq_weights/QWeights.pth"))
        self.TargetPolicyNetwork.load_state_dict(torch.load("config/saves/training_weights/"+env+"/softq_weights/TargetactorWeights.pth"))
        self.TargetQNetwork.load_state_dict(torch.load("config/saves/training_weights/"+env+"/softq_weights/TargetQWeights.pth"))