...
class TD3:
    ...
    def load(self,env):
        ...
        self.PolicyNetwork.load_state_dict(torch.load("config/saves/training_weights/"+env+"/td3_weights/actorWeights.pth"))
        self.TargetPolicyNetwork.load_state_dict(torch.load("config/saves/training_weights/"+env+"/td3_weights/TargetactorWeights.pth"))