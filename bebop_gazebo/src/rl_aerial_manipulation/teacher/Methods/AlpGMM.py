...
from rl_aerial_manipulation.replay_buffer.Teacher_RB import BufferedDataset
...
class ALPGMM():
    def __init__(self, mins, maxs, args, seed=None):
        self.seed = seed
        if not seed:
        ...
        self.potential_ks = np.arange(args.min_k, args.max_k, 1)
        ...
        alp_max_size = args.alp_max_size
        alp_buffer_size = args.alp_buffer_size
